...
bash "${ROOT_DIR}/tests/test_session_retention.sh"
bash "${ROOT_DIR}/tests/wrapper-dryrun.sh"
bash "${ROOT_DIR}/tests/test_version_command.sh"
bash "${ROOT_DIR}/tests/test_version_guard.sh"
...
bash "${ROOT_DIR}/tests/test_runtime_defaults.sh"
...
bash "${ROOT_DIR}/tests/test_startup_vacuum.sh"
