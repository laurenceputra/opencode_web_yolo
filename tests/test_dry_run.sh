...
assert_contains "$output" "command=opencode serve --hostname 0.0.0.0 --port 4096"
assert_not_contains "$output" "opencode web"
assert_contains "$output" "host_agents_source=none"
