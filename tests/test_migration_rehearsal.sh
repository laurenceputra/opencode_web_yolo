...
assert_contains "$output_dry_run" "Using host instruction file from opencode: ${HOME}/.config/opencode/AGENTS.md"
assert_contains "$output_dry_run" "-v ${HOME}/.config/opencode/AGENTS.md:/home/opencode/.config/opencode/AGENTS.md:ro"
